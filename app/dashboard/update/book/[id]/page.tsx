...
export default function BookUpdatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-3xl mx-auto px-4">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">更新書籍</h1>
          <p className="mt-2 text-gray-600">修改書籍資訊</p>
        </div>
              ...
              >
                {uploadingCoverImage ? (
                  ...
                  <>
                    ...
                    <p className="text-xs text-gray-500">支援 JPG, PNG, WebP（最大 5MB）</p>
                  </>
                )}
              </label>
            ) : (
